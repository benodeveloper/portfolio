...
export default function Nav() {
    ...
    return <div
        className="relative pt-6 lg:pt-8 flex items-center justify-between text-slate-700 font-semibold text-sm leading-6 dark:text-slate-200">
        <Link href="/" className="text-4xl font-bold text-white">Beno.</Link>
            ...
            <div className="hidden md:flex items-center">
                <nav>
                    <ul className="flex items-center space-x-8">
                        ...
                        <li>
                            <Link href="/about" className="hover:text-sky-500 dark:hover:text-sky-400">About me</Link>
                        </li>
                        <li>
                            <Link href="/blogs" className="hover:text-sky-500 dark:hover:text-sky-400"> Blog </Link>
                        </li>
                        <li>
                            <Link href="/contact" className="hover:text-sky-500 dark:hover:text-sky-400"> Contact</Link>
                        </li>
                    </ul>
                </nav>
                ...
                <div className="flex items-center border-l border-slate-200 ml-6 pl-6 dark:border-slate-800">
                    ...
                    <button type="button" onClick={toggleTheme} aria-haspopup="true"
                        aria-expanded="false"
