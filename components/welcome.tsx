...
export const Welcome = () => {
    ...
    <div className="grid grid-cols-8 grid-rows-34x4 mt-11">
        <div  className="row-span-4 col-span-1 md:col-span-2">
            <Image
            className="md:translate-y-3 md:max-w-[150px] max-w-[50px] translate-y-2"
            src={me}
            alt="hassan BENADARODOR" />
        </div>
        ...
        <div className="ml-4 col-span-7 md:col-span-6 md:row-span-1 md:flex">
            ...
            <span className="font-normal text-[#71767B] text-[15px] md:ml-3">@beno_developer</span>
        </div>
        <h3 className="md:ml-4 mt-3 md:mt-0 text-[#71767B] text-[18px] md:col-span-6 col-span-8 md:row-span-1">Full stack web developer</h3>
        <div className="md:ml-4 my-2 col-span-8 md:col-start-3 md:col-span-6 md:row-span-2">
