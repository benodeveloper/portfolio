    ...
    <div className={`absolute ${show ? "" : "hidden"} right-0 z-10 mt-48 w-36 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu`}>
      <div className="p-2 flex space-y-2 items-end flex-col">
        ...
        <FacebookShareButton className="my-3 " url={`https://benodeveloper.com/${post.url}`} quote={post.title}>
            <span className="text-blue-600">Facebook</span> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 ml-4 mb-1 inline-block fill-blue-600">
        ...
        <span className="text-blue-400">Twitter</span> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 ml-4 mb-1 inline-block fill-blue-400">
        ...
        <span className="text-blue-800">Linkedin</span> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 ml-4 mb-1 inline-block fill-blue-800">
