export default function SocialMedia() {
    return <div className="flex flex-row text-2xl my-6 text-gray-500 dark:text-gray-300">
        <a href="https://dev.to" target="_blank"
            rel="noopener noreferrer nofollow"
            className="hover:text-gray-800 dark:hover:text-white transition-colors mr-3">
        ...
        <a href="https://github.com" target="_blank" rel="noopener noreferrer nofollow" className="hover:text-gray-800 dark:hover:text-white transition-colors mr-3">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="1em"
                height="1em"
        ...
        <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer nofollow" className="hover:text-gray-800 dark:hover:text-white transition-colors ">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="1em"
                height="1em"
