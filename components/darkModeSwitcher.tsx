...
export const DarkModeSwitcher = () => {
    ...
    const renderIcon = () => {
        ...
        if (currentTheme === "dark") {
            return <svg xmlns="http://www.w3.org/2000/svg" className="fill-gray-50 h-5 w-5" viewBox="0 0 512 512">
            ...
            return <svg xmlns="http://www.w3.org/2000/svg" className="fill-gray-900 h-5 w-5" viewBox="0 0 384 512">
    ...
    return <button type='button' title='dark light switcher h-5 w-5' onClick={() => { theme == "light" ? setTheme('dark') : setTheme('light') }}>
        ...
        <motion.div whileTap={{ rotate: 90 }} className='fill-gray-900'>
            {renderIcon()}
        </motion.div>
    </button>
}