...
export const SocialFollow = () => {
    return <ul className="mt-7 flex gap-7">
        <li>
            <a href="https://twitter.com/beno_developer" title="twitter" rel="noreferrer noopener nofollow" target="_blank" className="flex text-neutral-500 dark:text-neutral-400 hover:text-indigo-500 dark:hover:text-blue-400/80 fill-neutral-500 dark:fill-neutral-400 hover:fill-indigo-500 dark:hover:fill-blue-400/80">
        ...
        <li>
            <a href="https://github.com/benodeveloper" title="github" rel="noreferrer noopener nofollow" target="_blank" className="flex text-neutral-500 dark:text-neutral-400 hover:text-indigo-500 dark:hover:text-blue-400/80 fill-neutral-500 dark:fill-neutral-400 hover:fill-indigo-500 dark:hover:fill-blue-400/80">
                <svg width={18} height={19} className="mr-2" xmlns="http://www.w3.org/2000/svg">
        ...
        <li>
            <a href="https://www.linkedin.com/in/benodeveloper" title="linkedin" rel="noreferrer noopener nofollow" target="_blank" className="flex text-neutral-500 dark:text-neutral-400 hover:text-indigo-500 dark:hover:text-blue-400/80 fill-neutral-500 dark:fill-neutral-400 hover:fill-indigo-500 dark:hover:fill-blue-400/80">
                <svg width={18} height={19} className="mr-2" xmlns="http://www.w3.org/2000/svg">
        ...
        <li>
            <a href="mailto:listoun.developer@gmail.com" title="email" rel="noreferrer noopener nofollow" target="_blank" className="flex text-neutral-500 dark:text-neutral-400 hover:text-indigo-500 dark:hover:text-blue-400/80 fill-neutral-500 dark:fill-neutral-400 hover:fill-indigo-500 dark:hover:fill-blue-400/80">
