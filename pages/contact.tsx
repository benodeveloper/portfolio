...
const Contact = () => {
    return <div className="h-max mt-60">
        <div>
            ...
            <h4 className="dark:text-neutral-400 text-lg text-neutral-600">I don’t mind hearing from you. Whether you want to ask something or just say hello, I’ll try my best to respond! You can reach me on</h4>
