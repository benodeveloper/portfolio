  ...
  return <> 
    <div className="grid grid-cols-8 grid-rows-34x4 mt-11">
        ...
        <div className="ml-4 col-span-7 md:col-span-6 md:row-span-1 md:flex">
            ...
            <span className="font-normal dark:text-gray-400 text-[15px] md:ml-3">@beno_developer</span>
        </div>
        <h3 className="md:ml-4 mt-3 md:mt-0 dark:text-gray-400 text-[18px] md:col-span-6 col-span-8 md:row-span-1">Full stack web developer</h3>
        
        <div className="md:ml-4 md:mt-7 my-2 col-span-8 md:col-start-3 md:col-span-6 md:row-span-2">
          <p>Welcome to my digital garden where I share what I'm learning about shipping great products, becoming a better developer and growing a career in tech.</p>
          <ul className="mt-7 flex gap-7 dark:text-gray-400">
            <li className="flex">
              <svg width={18} height={15} className="mr-2 fill-gray-400" xmlns="http://www.w3.org/2000/svg" >
            ...
            <li className="flex">
              <svg width={18} height={18} className="mr-2 fill-gray-400" xmlns="http://www.w3.org/2000/svg">
