...
description: "Many developers get confused about OAuth 2.0 and its purpose in web application security. Is it for authentication or authorization? The confusion is compounded when OpenID Connect is introduced, which builds on top of OAuth 2.0 and adds an identity layer."
...
<Img src={`/image.jpg`} bleed={false} width={1200} height={900}>
...
<Img src={`/oauth2-authorization-code-flow-diagram.jpg`} bleed={false} width={1200} height={900}>
